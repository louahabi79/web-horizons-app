...
@section('styles')
<link rel="stylesheet" href="{{ asset('css/member/discussions.css') }}">
@endsection
...
<div class="discussion-container">
    ...
    <div class="messages-section">
        ...
        <form action="{{ route('member.discussions.store', $article) }}" method="POST" class="message-form">
            @csrf
...
function rateArticle(note) {
    fetch('{{ route('member.articles.rate', $article) }}', {
        method: 'POST',
        headers: {
